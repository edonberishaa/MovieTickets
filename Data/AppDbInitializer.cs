            ...
            using (var serviceScope = applicationBuilder.ApplicationServices.CreateScope())
            {
                ...
                if (!context.Cinemas.Any())
                {
                    context.Cinemas.AddRange(new List<Cinema>()
                    {
                        ...
                        {
                            Name = "Cinema 1",
                            Logo= "http://dotnethow.net/images/cinemas/cinema1.jpeg",
                            Description = "This is the description for the first cinema"
                        },
                        new Cinema()
                        {
                            Name = "Cinema 2",
                            Logo= "http://dotnethow.net/images/cinemas/cinema2.jpeg",
                            Description = "This is the description for the second cinema"
                        },
                        new Cinema()
                        {
                            Name = "Cinema 1",
                            Logo= "http://dotnethow.net/images/cinemas/cinema3.jpeg",
                            Description = "This is the description for the third cinema"
                        },
                        new Cinema()
                        {
                            Name = "Cinema 4",
                            Logo= "http://dotnethow.net/images/cinemas/cinema4.jpeg",
                            Description = "This is the description for the fourth cinema"
                        },
                        new Cinema()
                        {
                            Name = "Cinema 5",
                            Logo= "http://dotnethow.net/images/cinemas/cinema5.jpeg",
                            Description = "This is the description for the fifth cinema"
                        },
                ...
                if (!context.Movies.Any())
                {
                    context.Movies.AddRange(new List<Movie>()
                    {
                        ...
                        {
                            Name = "Scoob",
                            Description ="This is the Scoob movie desc",
                            Price = 39.50,
                        ...
                        {
                            Name = "Race",
                            Description ="This is the Race movie desc",
                            Price = 39.50,
                        ...
                        {
                            Name = "Ghost",
                            Description ="This is the Ghost movie desc",
                            Price = 39.50,
                        ...
                        new Movie()
                        {
                            ...
                            Description ="This is the Shawshank Redemption  desc",
                            Price = 29.50,
                        ...
                        {
                            Name = "Life",
                            Description ="This is the Life movie desc",
                            Price = 39.50,
